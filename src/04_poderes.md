...
+1 ponto | 2D6 pontos de dano por rodada de combate | +2 pontos
...
O item é muito comum (fogo, luz solar, água, aço etc.) | +2 pontos | | Outro tipo de poder diferente daquele que o personagem tem (mágico vs. super, etc.), se usado | +2 pontos |
...
| O poder de longo alcance é apenas de toque | +1 ponto por nível | | O poder de alvo único tem alcance (15 pontos por nível)
