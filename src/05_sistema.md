...
Equipamento | Sem equipamento quando o equipamento é necessário | -50% | | Equipamento ruim ou improvisado
| Equipamento ruim ou improvisado | -20% | | Equipamento de alta qualidade e suprimentos superiores
...
Veículo espacial, futuro | Variações | Variações | Variações | Variações | Variações |
...
-1 para Movimento (MOV)
-5% para a rolagem da característica Agilidade
-5% para todas as habilidades de Agilidade, Manipulação, Furtividade, Esquiva e armas
