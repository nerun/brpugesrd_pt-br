...
Artilharia (vários) | Barganha | Arte (vários) | Avaliação | Brawl | Comando | Artesanato (vários) | Primeiros socorros
Arma de energia (vários) | Disfarce | Demolição | Jogos | Arma de fogo (vários) | Etiqueta | Etiqueta
Arma de fogo (vários) | Etiqueta (vários) | Manipulação fina | Conhecimento (vários) | Agarrar | Conversa rápida | Conhecimento (vários)
Conhecimento (vários) | Conhecimento (vários) | Grapple | Fast Talk | Máquina pesada (vários) | Alfabetização (opcional) | Arma pesada (vários)
Arma pesada (vários) | Linguagem (vários) | Reparo (vários) | Medicina | Artes marciais | Desempenho | Sinalização | Sinalização de voz
| Artes marciais | Performance | Perícia | Psicoterapia | Arma branca (vários)
...
Escutar | Esquivar-se | Andar (vários) | Navegar | Dirigir (vários)
Navegar | Dirigir (vários) | Furtividade | Pesquisa | Voar | Nadar | Ciclismo
Pesquisa | Voar | Nadar | Sentir | Esconder-se | Arremessar
| Sentir | Esconder-se | Arremessar |
| Localizar | Pular | Pular |
Rastrear | Pilotar (vários) | Rastrear | Pilotar (vários) |
...
| Manipulação | 05% | Demolição | Manipulação
| Demolição | Manipulação | 01% |
Disfarce | Comunicação | 01% | Esquiva | Físico | DEX
| Esquiva | Físico | DEX×2 |
| Arma de energia (vários) | Física | 20% ou 01% |
| Arma de energia (vários) | Combate | por especialidade de arma
Etiqueta (vários) | Comunicação | 05% | Conversa rápida | Comunicação | 05% | Etiqueta (vários)
Comunicação | Conversa rápida | Comunicação | 05% |
...
Conhecimento (vários) | Linguagem (vários) | Comunicação | INT (ou EDU)×5 ou 00% |
| Escuta | Percepção | 25% |
...
Desempenho | Comunicação | 05% | Persuasão | Comunicação | 15% | Persuasão
| Persuadir | Comunicação | 15% |
Pilotar (vários) | Físico | 01% | Projeção | Físico | DEX
...
Manipulação | 05% | Sense | Percepção | 10% | Escudo | Combate | por escudo | Sleight of Hand | Manipulation | 05% |
| Visão | Percepção | 25% |
...
| **Status** | **Social Rank** | **Wealth Rating** | **Maximum Wealth** |
|------------|--------------------|-------------------|--------------------|
| 01-39 | Classe baixa | Indigente | Indigente | Indigente
| 40-43 | Classe média baixa | Pobre | Média |
| 44-47 | Classe média | Média | Média | Média
| 48-49 Classe média alta Média Média
| 50-75 | Classe alta | Afluente | Afluente |
| 76-95 | Nobreza | Afluente | Rico |
96-00 | Monarquia | Rico | Rico | Rico |

**Status vitoriano/ocidental/polpudo/moderno

| **Status** | **Social Rank** | **Wealth Rating** | **Wealth Cap** | |
|------------|--------------------|-------------------|----------------|
| 01-14 | Classe baixa | Indigente | Pobre |
| 15-29 | Classe baixa | Pobre | Média |
| 30-39 Classe média baixa Média Afluente
| 40-75 | Classe média | Média | Afluente
| 76-95 | Classe média alta | Afluente | Rico
96-00 | Classe alta | Rico | Rico | Rico |
